package com.soneralci.artbookhilttesting.roomdb
...
class ArtDaoTest {
    ...
    fun insertArtTesting() = runBlockingTest{
        ...
        val exampleArt = Art("monaLisa","Davinci",1700,"test.com",1)
    ...
    fun deleteArtTesting() = runBlockingTest{
        val exampleArt = Art("scream","Edvar Minch",1800,"test.com",2)
        dao.insertArt(exampleArt)
